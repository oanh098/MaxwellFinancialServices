...
<head>
    ...
    <title>Single News from  MaxwellFinancialServices</title>
                        ...
                        <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                            ...
                            <tr>
                                <td align="center" height="70" style="height:70px;">
                                    <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="250" border="0" style="display: block; width: 220px;" src="{{asset('FrontEnd')}}/logo-news.png" alt="" /></a>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                <tr>
                    ...
                    <td align="center" class="section-img">
                        <a href="" style=" border-style: none !important; display: block; border: 0 !important;"><img src="{{asset('FrontEnd')}}/img-news.png" style="display: block; width: 590px;" width="590" border="0" alt="" /></a>
                ...
                <tr>
                    <td>
                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                            ...
                            <tr>
                                <div dir="ltr">
                                    <div style="color: #888888; font-size: 14px; font-family: Lucida Grande,Tahoma; font-weight: 400;width:130px;max-width:130px;min-width:100px;float:left;padding-top:15px">
                                        <img src="{{asset('FrontEnd')}}/logo-news.png" style="margin-top: 0.5em;margin-left:0.1em;width:120px;"></div>
                                    <div style="width:300px;max-width:300px;
                                    font-family:Lucida Grande,Tahoma;font-size:12px;
                                    margin-top:0.5em;color:rgb(102,102,102);
                                    letter-spacing:2px;border-left:2px solid rgb(211,216,215);padding-top:3px;padding-left:10px;overflow:hidden">
                                        <p>MaxwellFinacialServices<br></p>
                                        <p>Melbourne: +12 345 678 910<br>
                                            Sydney: +61 291 583 232<br>
                                            London: +44 330 027 2008<br>
                                            <a href="http://maxwellfinancialservices.com/" style="margin-top:0.5em;color:rgb(102,102,102);text-decoration:none" target="_blank">maxwellfinancialservices.com</a>
                                            <br>
                                        </p>
                            ...
                            <tr>
                                <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                    <div style="line-height: 24px;">
                                        ...
                                        <span style="color: #333333;">MaxwellFinancialService</span>
