    ...
    <div class="container ">
        <div class="row " >
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
                <div class="">
                    <p><img src="{{asset('FrontEnd')}}/images/icon_arrow_up18.png" alt="Business Growth" />
                        <a href="#" style="margin-left: 1em; color:rgba(0,0,255,1);">Business Growth
                        </a>
                    </p>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="html_content">
                    <p><img src="{{asset('FrontEnd')}}/images/search-solution-48549718.png" alt="Product Solutions" />
                        
                        <a href="#" style="margin-left: 1em; color:rgba(0,0,255,1);">Product Solutions
                        </a>
                    </p>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="html_content">
                    <p><img src="{{asset('FrontEnd')}}/images/5217.png" alt="Liabilities Management" />
                           
                        <a href="#" style=" margin-left: 1em; color:rgba(0,0,255,1);">Liabilities Management
                            </a>
                    </p>
        ...
        <div class="row" >
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="html_content">
                    <p><img src="{{asset('FrontEnd')}}/images/7517.png" alt="Research Strategy" />
                        <a href="#" style=" margin-left: 1em; color:rgba(0,0,255,1);">Research & Strategy
                        </a>
                    </p>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="html_content">
                    <p><img src="{{asset('FrontEnd')}}/images/7417.png" alt="Transition service" />
                        <a href="#" style=" margin-left: 1em; color:rgba(0,0,255,1);">Transition service
                            </a>
                    </p>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="html_content">
                    <p><img src="{{asset('FrontEnd')}}/images/5517.png" alt="Clearing and Execution" />
                        <a href="#" style=" margin-left: 1em; color:rgba(0,0,255,1);">Clearing and Execution
                                </a>
                    </p>
