            ...
            <div class="menu-center collapse navbar-collapse">
                ...
                <ul class="ttr_menu_items nav navbar-nav navbar-right">
                    <li class="ttr_menu_items_parent dropdown active">
                        <a href="index" class="ttr_menu_items_parent_link_active">
                    ...
                    <li class="ttr_menu_items_parent dropdown">
                        <a href="#" class="ttr_menu_items_parent_link_arrow dropdown-toggle" data-toggle="dropdown">
                            <span class="menuchildicon"></span>Services</a>
                        <hr class ="horiz_separator"/>
                    ...
                    <li class="ttr_menu_items_parent dropdown">
                        <a href="resource" class="ttr_menu_items_parent_link">
                            <span class="menuchildicon"></span>Resource</a>
                        <hr class ="horiz_separator"/>
                    </li> <!-- main menu list closing -->
                    <li class="ttr_menu_items_parent dropdown">
                        <a href="contact" class="ttr_menu_items_parent_link">
                            <span class="menuchildicon"></span>Contact</a>
                    </li> <!-- main menu list closing -->
                </ul>
            </div>
        </div>
